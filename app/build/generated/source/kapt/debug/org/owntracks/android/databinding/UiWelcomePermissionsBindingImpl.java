...
public class UiWelcomePermissionsBindingImpl extends UiWelcomePermissionsBinding implements org.owntracks.android.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((org.owntracks.android.ui.welcome.permission.PermissionFragmentMvvm.ViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable org.owntracks.android.ui.welcome.permission.PermissionFragmentMvvm.ViewModel Vm) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeVm((org.owntracks.android.ui.welcome.permission.PermissionFragmentMvvm.ViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeVm(org.owntracks.android.ui.welcome.permission.PermissionFragmentMvvm.ViewModel Vm, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
        ...
        else if (fieldId == BR.permissionGranted) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
            return true;
    ...
    protected void executeBindings() {
        ...
        org.owntracks.android.ui.welcome.permission.PermissionFragmentMvvm.ViewModel<? extends org.owntracks.android.ui.base.view.MvvmView> vm = mVm;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        // vm
        org.owntracks.android.ui.welcome.permission.PermissionFragmentMvvm.ViewModel vm = mVm;
    ...
    /* flag mapping
        flag 0 (0x1L): vm
        flag 1 (0x2L): vm.permissionGranted
        flag 2 (0x3L): null
    flag mapping end*/
    //end
}