...
public class UiWelcomePlayBindingImpl extends UiWelcomePlayBinding implements org.owntracks.android.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((org.owntracks.android.ui.welcome.play.PlayFragmentMvvm.ViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable org.owntracks.android.ui.welcome.play.PlayFragmentMvvm.ViewModel Vm) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeVm((org.owntracks.android.ui.welcome.play.PlayFragmentMvvm.ViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeVm(org.owntracks.android.ui.welcome.play.PlayFragmentMvvm.ViewModel Vm, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        org.owntracks.android.ui.welcome.play.PlayFragmentMvvm.ViewModel<? extends org.owntracks.android.ui.base.view.MvvmView> vm = mVm;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            if ((dirtyFlags & 0xdL) != 0) {
                    ...
                    if (vm != null) {
                        ...
                        vmFixAvailable = vm.isFixAvailable();
                    }
            }
        }
        // batch finished
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        // vm
        org.owntracks.android.ui.welcome.play.PlayFragmentMvvm.ViewModel vm = mVm;
