...
public class UiWelcomeBindingImpl extends UiWelcomeBinding implements org.owntracks.android.generated.callback.OnClickListener.Listener {
    ...
    private UiWelcomeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (org.owntracks.android.support.widgets.PausableViewPager) bindings[3]
            );
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((org.owntracks.android.ui.welcome.WelcomeMvvm.ViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable org.owntracks.android.ui.welcome.WelcomeMvvm.ViewModel Vm) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeVm((org.owntracks.android.ui.welcome.WelcomeMvvm.ViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeVm(org.owntracks.android.ui.welcome.WelcomeMvvm.ViewModel Vm, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
        ...
        else if (fieldId == BR.nextEnabled) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
            return true;
        }
        else if (fieldId == BR.doneEnabled) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
            return true;
    ...
    protected void executeBindings() {
        ...
        org.owntracks.android.ui.welcome.WelcomeMvvm.ViewModel<? extends org.owntracks.android.ui.base.view.MvvmView> vm = mVm;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            if ((dirtyFlags & 0xdL) != 0) {
                    ...
                    if (vm != null) {
                        // read vm.doneEnabled
                        vmDoneEnabled = vm.isDoneEnabled();
                    }
            }
            if ((dirtyFlags & 0xbL) != 0) {
                    ...
                    if (vm != null) {
                        // read vm.nextEnabled
                        vmNextEnabled = vm.isNextEnabled();
                    }
            }
        }
        // batch finished
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            case 1: {
                ...
                // vm
                org.owntracks.android.ui.welcome.WelcomeMvvm.ViewModel vm = mVm;
    ...
    /* flag mapping
        flag 0 (0x1L): vm
        flag 1 (0x2L): vm.nextEnabled
        flag 2 (0x3L): vm.doneEnabled
        flag 3 (0x4L): null
    flag mapping end*/
    //end
}