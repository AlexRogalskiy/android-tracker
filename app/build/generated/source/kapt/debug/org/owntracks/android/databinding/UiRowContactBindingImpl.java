...
public class UiRowContactBindingImpl extends UiRowContactBinding  {
    ...
    protected void executeBindings() {
        ...
        java.lang.String contactToString = null;
        ...
        if ((dirtyFlags & 0x1fL) != 0) {
            ...
            if ((dirtyFlags & 0x11L) != 0) {
                    ...
                    if (contact != null) {
                        // read contact.toString()
                        contactToString = contact.toString();
                    }
            }
        ...
        if ((dirtyFlags & 0x11L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.location, org.owntracks.android.support.widgets.BindingConversions.convertToString(contactToString));
        }
        if ((dirtyFlags & 0x19L) != 0) {
            // api target 1
